...
public class StudentHomeUI extends JFrame {
	...
	private void initialize() {
		...
		txtpnRecentMessages.setText("Recent Messages");
		...
		JList listCurrentBookings = new JList();
		listCurrentBookings.setModel(new AbstractListModel() {
			String[] values = new String[] { "CE2004 jioasdf",
					"CE2994 joi;zisdjf" };
		...
		JList listAvailableCourses = new JList();
		...
		JList listAvailableSessions = new JList();
		...
		getTableReview().setModel(new DefaultTableModel(new Object[][] {
				{ "43901341534", "CE2006 Software Engineering",
						"21/4/2014 1530-1730", "A", "N.A." },
				{ null, "", null, null, null }, }, new String[] { "Record ID",
				"Course", "Session", "Grade", "Remark" }) {
