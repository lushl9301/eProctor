...
public class ChatMessage implements Serializable {
    ...
    public User currentUser = Main.currentUser; // change to username:String - cly
    ...
    public ChatMessage(int type, ArrayList<ArrayList<String>> message) {
        ...
        ArrayList<String> userId = new ArrayList<String>(); // change to username // username is just a String, why use ArrayList - cly
