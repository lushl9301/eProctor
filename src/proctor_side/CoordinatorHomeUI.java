...
public class CoordinatorHomeUI extends JFrame {

    private JTable tableReview;

    public CoordinatorHomeUI() {
    ...
    private void initialize() {
        ...
        txtpnInfomation.setText(Main.coordinatorHomeController.getInformation());
        ...
        txtpnRecentMessages.setText(Main.coordinatorHomeController
                .getRecentMessage());
         ...
         * TODO
         * 
         * 1. get student list 2. display 3. Coordinator select 4. build up socket
        ...
        listCurrentBookings.setModel(new AbstractListModel<String>() {
            String[] values = Main.coordinatorHomeController
        ...
        btnMakeARequest.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                Main.coordinatorHomeController.makeRequestOfABooking(index);
            }
        });
        ...
        mntmLogout.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                Main.coordinatorHomeController.logout();
            }
        });
        ...
        mntmExit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                Main.coordinatorHomeController.exit();
            }
        });
        mnFile.add(mntmExit);
        ...
        mntmAbout.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                Main.coordinatorHomeController.getAboutMessage();
            }
        });
